...
data = pd.read_csv('phyluminfo.csv')

fig, axes = plt.subplots(3,1, figsize = (9,8))

axes[0].axhline(y = 1407, color = '#B8B8B8', linestyle = ':', zorder = 0)
sns.boxplot(ax = axes[0], x='Name', y='Reactions', data = data, color = '#9bc283')
...
sns.boxplot(ax=axes[1], x='Name', y = 'Genes', data = data, color = '#649c5f')
...
sns.boxplot(ax = axes[2], x='Name', y = 'Metabolites', data = data, color = '#1a5920')
